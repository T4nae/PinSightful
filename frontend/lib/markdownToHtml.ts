...
function tag(
    ...
    const defaultStyle = "display: flex; flex-wrap: wrap; width: 100%;";

    if (attributes && attributes.style) {
        attributes.style = `${defaultStyle} ${attributes.style}`;
    } else {
        attributes = {
            ...attributes,
            style: defaultStyle,
